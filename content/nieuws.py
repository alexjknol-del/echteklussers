...
"""),
    ...
    ("loonkosten-bouw-2026", "2026-08-20", "Thu, 20 Aug 2026 09:00:00 +0200",
     ...
     "De verhouding is omgedraaid: waar materiaalprijzen jarenlang het beeld bepaalden, zit de stijging nu vooral in arbeid. Dat raakt vooral arbeidsintensieve klussen.",
     """
Het Centraal Bureau voor de Statistiek meldt over juni 2026 een stijging van vijf procent
in de bouwkosten voor woningbouw ten opzichte van een jaar eerder. De opbouw van die
stijging is interessanter dan het getal zelf.

## Arbeid boven materiaal

De loonindex kwam uit op 128,3 punten, een stijging van 5,4 procent op jaarbasis. Het CBS
noemt die component de belangrijkste opwaartse kracht. De materiaalindex stond op 129,9
punten, een stijging van 4,6 procent, en groeit daarmee gematigder. De totale
inputprijsindex voor nieuwbouwwoningen kwam uit op 127,1 punten, met 2021 als basisjaar.

## Wat dat betekent per type klus

Een klus waarin veel arbeid zit en weinig materiaal, reageert sterker op deze ontwikkeling
dan een klus waarin het omgekeerde geldt.

| Type klus | Aandeel arbeid | Gevoeligheid |
| --- | --- | --- |
| Schilderwerk | hoog | sterk |
| Stucwerk | hoog | sterk |
| Tegelwerk | gemiddeld | gemiddeld |
| Keuken plaatsen | laag | beperkt |
| Glas vervangen | laag | beperkt |

Voor schilderwerk betekent dat concreet: een offerte van vorig seizoen ligt dit seizoen
merkbaar hoger, ook als het werk identiek is.

## Gevolg voor de offerte

Een geldigheidsduur van dertig tot zestig dagen op een offerte is in dit licht geen
verkooptechniek maar een reële beperking. Wie een offerte een half jaar laat liggen en dan
alsnog opdracht geeft, kan een aangepaste prijs verwachten.

Voor wie meerdere offertes vergelijkt: offertes van verschillende datum zijn niet zonder
meer vergelijkbaar. Vraag ze binnen een periode van enkele weken op.

De cijfers staan op https://www.cbs.nl
"""),

    ("acm-nepreviews", "2026-07-02", "Thu, 02 Jul 2026 09:00:00 +0200",
     "ACM pakt handel in nepreviews aan",
     "De Autoriteit Consument en Markt richt zich op partijen die nepreviews en neplikes verkopen. Voor consumenten blijft het de vraag hoe een echte beoordeling te herkennen is.",
     "Wat de regels zijn rond reviews, waar de ACM op handhaaft en welke patronen op vervalste beoordelingen wijzen.",
     """
De Autoriteit Consument en Markt treedt op tegen de handel in nepreviews en neplikes. Dat
richt zich zowel op verkopers als op afnemers van die diensten. Voor consumenten die een
klusbedrijf zoeken, is dat relevant, want beoordelingen zijn voor veel mensen het
belangrijkste selectiemiddel.

## De regels

De eisen aan het gebruik van reviews volgen uit de artikelen 6:193c tot en met 6:193g van
het Burgerlijk Wetboek. Samengevat:

- Nepreviews plaatsen of laten plaatsen is verboden
- Uitsluitend positieve reviews tonen en negatieve weglaten is misleidend
- Een vergoeding, korting of gratis product in ruil voor een review moet vermeld worden
- De herkomst van de reviews, de periode en de berekening van het gemiddelde moeten duidelijk zijn
- Een bedrijf dat reviews toont, hoort te controleren of ze echt zijn

## Patronen die opvallen

Voor wie beoordelingen leest bij het zoeken naar een vakman, vallen vervalsingen vaak op
aan het patroon, niet aan de losse tekst.

- Veel beoordelingen in een korte periode, daarna maanden stilte
- Alleen sterren, zonder tekst
- Teksten die het bedrijf voluit met de plaatsnaam noemen, alsof het een zoekterm is
- Recensenten met precies één beoordeling in hun profiel
- Uitsluitend vijf sterren over honderden beoordelingen

## Wat wel iets zegt

De manier waarop een bedrijf reageert op kritiek zegt meer dan het gemiddelde cijfer. Een
inhoudelijke reactie zonder verwijten wijst op een organisatie die klachten oppakt.
Beoordelingen die een concreet detail noemen, zoals de naam van de vakman of het type klus,
zijn moeilijker te verzinnen dan algemene lof.

Meer over de regels staat op https://www.acm.nl
"""),

    ("zzp-handhaving-2026", "2026-05-28", "Thu, 28 May 2026 09:00:00 +0200",
     "Zzp-handhaving in 2026: geen verzuimboetes, wel naheffingen",
     "Het kabinet verlengde de zachte landing bij de handhaving op schijnzelfstandigheid. Voor particuliere opdrachtgevers verandert er weinig, voor bedrijven wel.",
     "Wat de stand van zaken rond de Wet DBA betekent voor klusbedrijven en voor wie een zzp'er inhuurt.",
     """
De handhaving op schijnzelfstandigheid blijft in 2026 in een overgangsfase. Het kabinet
verlengde de zogeheten zachte landing, waardoor er geen verzuimboetes worden opgelegd.
Andere instrumenten blijven wel beschikbaar.

## Wat wel kan

De Belastingdienst kan naheffingen opleggen voor loonheffingen en premies over werk vanaf
2025. Vergrijpboetes zijn in 2026 mogelijk, maar alleen bij aantoonbare opzet of grove
schuld. De standaardaanpak begint met een bedrijfsbezoek en een waarschuwing; een
boekenonderzoek volgt pas wanneer er daadwerkelijk wordt nageheven.

## Wat dit betekent voor particuliere opdrachtgevers

Voor een particulier die een klusser inhuurt, verandert er weinig. De regels rond
schijnzelfstandigheid gaan over de relatie tussen opdrachtgever en opdrachtnemer in een
werkverhouding die op een dienstbetrekking lijkt: vaste werktijden, gezagsverhouding,
langdurige inzet voor één opdrachtgever. Een klus van een dag valt daar niet onder.

Wel praktisch relevant: een klusbedrijf dat met zzp'ers werkt en die als eigen personeel
inzet, loopt een risico dat uiteindelijk bij dat bedrijf ligt, niet bij de particuliere
klant.

## Waar het wel speelt

Bij grotere verbouwingen waarbij een hoofdaannemer met onderaannemers werkt, is de
constructie relevanter. Voor de opdrachtgever is het praktische punt vooral dat de
hoofdaannemer het aanspreekpunt blijft, ook voor werk dat door een ander is uitgevoerd. Die
afspraak hoort in de overeenkomst te staan.

## Wat te vragen

- Wordt het werk door eigen personeel uitgevoerd of door onderaannemers
- Wie is aansprakelijk voor het werk van die onderaannemers
- Wie is het aanspreekpunt bij een gebrek na oplevering
"""),

    ("werk-aan-de-deur", "2026-04-16", "Thu, 16 Apr 2026 09:00:00 +0200",
     "Werk aan de deur: het patroon is elk voorjaar hetzelfde",
     "Ongevraagde aanbiedingen voor dakwerk, voegwerk en gevelreiniging volgen een vast stramien. Wie toch tekent, heeft veertien dagen bedenktijd.",
     "Hoe ongevraagd aangeboden klussen werken, welke rechten er zijn en waarom een lage startprijs zelden de eindprijs is.",
     """
Zodra het weer omslaat, verschijnen de aanbiedingen aan de deur: een dak dat er slecht bij
ligt, voegwerk dat aan vervanging toe is, mos op de gevel. Het aanbod is ongevraagd, de
prijs is laag en het werk kan direct beginnen.

## Het patroon

1. Een aanbelbezoek met de mededeling dat er toevallig in de straat wordt gewerkt
2. Een korte inspectie waarna een probleem wordt vastgesteld dat vanaf de grond niet zichtbaar is
3. Een startprijs die opvallend laag ligt
4. Werk dat halverwege duurder blijkt, omdat er meer aan de hand is
5. Druk om contant af te rekenen, vaak zonder factuur

De constructie is niet altijd oplichting in juridische zin, maar het resultaat is
vergelijkbaar: werk van onduidelijke kwaliteit tegen een prijs die achteraf niet meer te
toetsen is.

## Wat de wet biedt

Een overeenkomst die buiten de bedrijfsruimte wordt gesloten, bijvoorbeeld aan de
voordeur of aan de keukentafel, geeft consumenten veertien dagen bedenktijd op grond van
artikel 6:230o van het Burgerlijk Wetboek. Die termijn begint pas te lopen zodra de
consument correct over dat recht is geïnformeerd. Gebeurt dat niet, dan loopt de termijn
door, tot maximaal twaalf maanden en veertien dagen.

Belangrijk detail: wordt het werk op verzoek van de consument binnen die bedenktijd
uitgevoerd, dan kan er wel een vergoeding verschuldigd zijn voor het verrichte deel. Het is
dus niet zo dat werk binnen veertien dagen altijd gratis ongedaan gemaakt wordt.

## Praktische lijn

- Geen opdracht geven bij de deur, hoe redelijk het aanbod ook klinkt
- Een tweede offerte opvragen bij een bedrijf dat zelf gevonden is
- Bij een gemeld gebrek aan het dak: zelf laten controleren door een partij zonder belang bij de uitkomst
- Niet contant betalen en altijd om een factuur vragen

Meldingen van misleidende handelspraktijken kunnen naar de Autoriteit Consument en Markt
via https://www.acm.nl
"""),

    ("wachttijden-vakmensen", "2026-03-12", "Thu, 12 Mar 2026 09:00:00 +0100",
     "Wachttijden voor kleine klussen lopen op in het voorjaar",
     "Vanaf maart schuiven tuin-, schilder- en dakklussen tegelijk de agenda in. Wie in het voorjaar belt voor buitenwerk, staat achteraan.",
     "Waarom de vraag naar vakmensen seizoensgebonden is, en welke klussen zich lenen voor het laagseizoen.",
     """
De vraag naar vakmensen is niet gelijk verdeeld over het jaar. Vanaf maart komen drie
stromen tegelijk op gang: tuinwerk, buitenschilderwerk en dakonderhoud. Het gevolg is dat
de wachttijd voor buitenwerk in het voorjaar oploopt terwijl die in januari kort is.

## Wat wanneer speelt

| Periode | Drukte |
| --- | --- |
| Januari en februari | Binnenwerk, laagseizoen voor buiten |
| Maart tot mei | Tuinaanleg, buitenschilderwerk, dakonderhoud |
| Juni tot augustus | Vakantieperiode, minder capaciteit |
| September en oktober | Laatste ronde buitenwerk voor de winter |
| November en december | Binnenwerk, schilderwerk binnen |

## Wat dat betekent

Buitenschilderwerk vraagt een temperatuur boven ongeveer vijf graden en een droge
ondergrond. Dat beperkt het seizoen tot ruwweg april tot oktober, en dus concentreert de
vraag zich daar. Wie in maart belt voor schilderwerk in mei, heeft kans. Wie in mei belt
voor mei, meestal niet.

Voor binnenwerk geldt het omgekeerde. Januari en februari zijn de maanden waarin schilders,
stukadoors en tegelzetters ruimte in de agenda hebben. Een badkamer of een binnenschilderbeurt
in die periode plannen levert kortere wachttijden op en soms een scherpere prijs.

## Kleine klussen

Voor losse klussen binnenshuis, zoals lampen ophangen, meubelmontage of een kraan
vervangen, geldt die seizoensgevoeligheid minder. Dat werk is het hele jaar planbaar en
loopt niet tegen weersomstandigheden aan.

> Voor dat type klussen is online een datum en tijdslot te kiezen bij Kleine-Klussen.nl,
> waarna een vakman uit het netwerk langskomt. Zie https://www.kleine-klussen.nl/

## Praktische volgorde

1. Buitenwerk aanvragen in het voorafgaande najaar of in januari
2. Binnenwerk plannen in de wintermaanden
3. Spoedwerk apart houden van planbaar werk, want de tarieven verschillen fors
"""),

    ("offerte-of-uurtarief-praktijk", "2026-01-29", "Thu, 29 Jan 2026 09:00:00 +0100",
     "Wanneer een uurtarief goedkoper uitpakt dan een vaste prijs",
     "Bij werk dat vooraf niet af te bakenen is, rekent een vaste prijs het risico mee. Bij duidelijk omschreven werk is het omgekeerde waar.",
     "Een vergelijking tussen de twee afspraakvormen, met de wettelijke regel over richtprijzen erbij.",
     """
Een vaste prijs voelt veiliger dan een uurtarief. Dat klopt bij werk dat vooraf duidelijk
te omschrijven is, en niet bij werk waarvan de omvang pas tijdens de uitvoering blijkt.

## Waarom een vaste prijs een opslag bevat

Bij een vaste prijs neemt de uitvoerder het risico over. Wat er achter de wand blijkt, komt
dan voor diens rekening. Dat risico wordt in de prijs verwerkt. Bij goed omschreven werk is
die opslag klein, bij onduidelijk werk groot, en soms weigert een vakman een vaste prijs
juist omdat het risico niet in te schatten is.

## Wanneer welk model

| Situatie | Passende vorm |
| --- | --- |
| Badkamer betegelen, oppervlak bekend | Vaste prijs |
| Kozijn vervangen, maten bekend | Vaste prijs |
| Lijst van tien losse klussen | Uurtarief |
| Storing zoeken in de elektra | Uurtarief |
| Houtrot herstellen, omvang onbekend | Uurtarief met maximum |
| Dak vervangen | Vaste prijs |

## De richtprijs

Er bestaat een tussenvorm die vaak verkeerd wordt begrepen. Een richtprijs is geen vaste
prijs. Artikel 7:752 van het Burgerlijk Wetboek bepaalt dat een richtprijs met maximaal
tien procent mag worden overschreden, tenzij de opdrachtgever tijdig is gewaarschuwd over
een grotere overschrijding. Die waarschuwing moet komen op een moment dat er nog een keuze
is, niet achteraf bij de factuur.

## De afspraak die het risico beperkt

Bij een uurtarief is één afspraak beslissend: een maximum aantal uren, met de verplichting
contact op te nemen voordat dat maximum wordt bereikt. Zonder plafond is de rekening open,
ook bij een redelijk tarief.

Verder hoort vooraf vast te staan of het tarief inclusief of exclusief btw is, of
voorrijkosten apart komen, en hoe reistijd wordt gerekend bij werk buiten de eigen regio.
"""),
]
